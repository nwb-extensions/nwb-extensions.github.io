...
The [staged-extensions](https://github.com/nwb-extensions/staged-extensions) repository is a place to submit new NWB:N extension records, i.e., before a ndx-custom-record repo exists for the extension.

#### 2.2.3 ndx-custom-record: Custom extension catalog record

The NDX Catalog contains a collection of ndx-custom-records created by the creators of the extensions. See below for further details.
